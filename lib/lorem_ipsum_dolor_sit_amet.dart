...
final actsList = {
  ...
  10: "Акт об огранич/приостанов представления коммунальной услуги электроснабжения",
...
// Техническая возможность введения ограничения
final List<String> restrictionPosibilityValues = ['Возможно', 'Невозможно'];
