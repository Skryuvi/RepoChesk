...
class RenewalPowerPage extends StatefulWidget {
  final String title;

  const RenewalPowerPage({Key? key, required this.title}) : super(key: key);

  @override
  State<RenewalPowerPage> createState() => _RenewalPowerPageState();
}

class _RenewalPowerPageState extends State<RenewalPowerPage> {
          ...
          child: Container(
            ...
            child: ListView(
              ...
              children: [
                ...
                SizedBox(height: 18),
                dateField('Дата введения ограничения/приостановления', _dateController, 'date_with_time'),
                ...
                SizedBox(height: 18),
                filledTextField('Наименование энергопринимающих устройств', _Controller),
